...
- For high-risk fleet, session, credential, release, destructive, or recovery mutations, delegate independent high-reasoning audit, plan review, and execution roles. Prefer Sol at high; otherwise state the fallback. The coordinator stays read-only and the executor follows the reviewed scope only.
