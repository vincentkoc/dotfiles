...
tmux set-option -gq @hn_ticker_reserved_width "${HN_TICKER_RESERVED_WIDTH:-176}"
tmux set-option -gq @hn_ticker_min_width "${HN_TICKER_MIN_WIDTH:-24}"
tmux set-option -gq @hn_ticker_max_width "${HN_TICKER_MAX_WIDTH:-96}"
