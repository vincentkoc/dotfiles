...
tmux set-option -gq @hn_ticker_reserved_width "${HN_TICKER_RESERVED_WIDTH:-150}"
tmux set-option -gq @hn_ticker_max_width "${HN_TICKER_MAX_WIDTH:-120}"
tmux set-option -gq @hn_ticker_speed "${HN_TICKER_SPEED:-0.06}"
